...
<div class="max-w-3xl mx-auto pb-10 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-white tracking-tight">Add New Category</h2>
                <p class="text-white/60 text-sm mt-1">Create a new category to organize your menu items.</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 backdrop-blur-sm relative overflow-hidden">
        ...
        <form action="{{ route('admin.category.store') }}" method="POST" class="relative z-10 space-y-6">
            @csrf
